...
class PasswordController extends Controller
{
    ...
    function verificationMail(Request $request) {
        ...
        return response()->json(['error'=> false, 'message' => 'Reset Password Successfully.'],200);
    }
    ...
    function isValidateCodeToken($codeArr,$key,$code) {
        return ($key == $codeArr['key'] && $code == $codeArr['code'] && $codeArr['key'] != null && $codeArr['code'] != null)?true:false;
    }
